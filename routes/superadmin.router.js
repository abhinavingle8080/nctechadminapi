...
const superadminMidd = require("../middleware/superadmin.middleware");
const validator = require("../validation/requests/admin");
...
const RoleModuleController = require("../controllers/superadmin/roleModule.controller");
const RolePermissionController = require("../controllers/superadmin/rolePermission.controller");
...
// RoleModule
router.post("/fetch-role-modules", passport.authenticate("jwt", { session: false }), superadminMidd.checkUser, RoleModuleController.fetchRoleModule);
router.post("/fetch-all-modules", passport.authenticate("jwt", { session: false }), superadminMidd.checkUser, RoleModuleController.fetchAllModules);
router.post("/get-all-modules", passport.authenticate("jwt", { session: false }), superadminMidd.checkUser, RoleModuleController.getAllModules);
router.post(
  "/fetchAllModulesByRole",
  validator.fetchModulesByRoleIDValidation,
  errorHandler,
  passport.authenticate("jwt", { session: false }),
  superadminMidd.checkUser,
  RoleModuleController.fetchModulesByRoleID
);
router.post("/addUpdatePermissions", passport.authenticate("jwt", { session: false }), superadminMidd.checkUser, RolePermissionController.addUpdateRolePermissions);
...
// Note routes
router.post("/create-notes", passport.authenticate("jwt", { session: false }), noteController.createNote);
router.post("/get-notes", passport.authenticate("jwt", { session: false }), noteController.getAllNotes);
router.post("/get-note", passport.authenticate("jwt", { session: false }), noteController.getNoteById);
